export default {
    ...
    notes: {
        ...
        titlePlaceholder: 'Not başlığını girin',
        contentPlaceholder: 'Not içeriğini girin',
        summaryPlaceholder: 'Not özeti burada görünecek',
        save: 'Kaydet',
        saving: 'Kaydediliyor...',
        ...
        createSuccess: 'Not başarıyla oluşturuldu',
        content: 'İçerik',
        summary: 'Özet',
